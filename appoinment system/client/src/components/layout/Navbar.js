...
const Navbar = (
        ...
        const authUserLinks = (
            <Fragment>
                ...
                <img className="nav-log-img" style={{width: "3.2rem"}} src={require("./doctor (1).png")} />       
                </Link>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item active">
                            <Link to="/profiles" className="nav-link">Counselor</Link>
                        </li>
                        <li className="nav-item active">
        ...
        const guestLinks = (
            <Fragment>
                <Link className="nav-logo" to="/">
                   <img src='./images/logo_1.png'  style={{width: '80px'}}/>       
                </Link>
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false"
                aria-label="Toggle navigation">
                    <span className="navbar-toggler-icon"></span>
                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown active">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <Link className="dropdown-item" to="/loginDoctor"><i className="fas fa-user-md"></i> Login as Counselor</Link>
                            </div>
                        </li>
                    <li className="nav-item dropdown active">
                            <Link className="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <Link className="dropdown-item" to="/registerUser"><i className="fas fa-users"></i> Register User</Link>
                                <Link className="dropdown-item" to="/registerDoctor"><i className="fas fa-user-md"></i> Register as Counselor</Link>
                            </div>
                        </li>
                </ul>
                </div>
